(function () {
  ...
  function generateEmailHTML() {
    ...
    var btnHtml =
      btnOn && btnTxt
        ? '<div style="margin-top:30px;text-align:center;"><a href="' +
          (btnLnk || "#") +
          '"' +
          (btnTab && btnLnk ? ' target="_blank"' : "") +
          ' style="line-height:100%;text-decoration:none;display:inline-block;max-width:100%;background-color:' +
          btnBg +
          ";color:" +
          btnTxtClr +
    ...
    if (footerOn) {
      ...
      if (instaOn)
        socCells +=
          '<td style="padding:0 15px;"><a href="' +
          (instaUrl || "#") +
          '" target="_blank" rel="noopener noreferrer"><img alt="Instagram" src="https://cdn-icons-png.flaticon.com/512/2111/2111463.png" style="display:block;outline:none;border:none;text-decoration:none;border-radius:100%;" width="35" /></a></td>';
      if (teleOn)
        socCells +=
          '<td style="padding:0 15px;"><a href="' +
          (teleUrl || "#") +
          '"  target="_blank" rel="noopener noreferrer"><img alt="Telegram"  src="https://cdn-icons-png.flaticon.com/512/2111/2111644.png" style="display:block;outline:none;border:none;text-decoration:none;border-radius:10%;"  width="30" /></a></td>';
      if (ytOn)
        socCells +=
          '<td style="padding:0 15px;"><a href="' +
          (ytUrl || "#") +
          '"    target="_blank" rel="noopener noreferrer"><img alt="YouTube"   src="https://cdn-icons-png.flaticon.com/512/1384/1384060.png" style="display:block;outline:none;border:none;text-decoration:none;border-radius:10%;"  width="35" /></a></td>';
  ...
  window.copyHTML = function () {
    navigator.clipboard.writeText(generateEmailHTML()).then(function () {
      ...
      setTimeout(function () {
        ...
        btn.innerHTML =
          '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/></svg> Copiar HTML';
      }, 2500);
    });
  };
